...
public final class Utils {
  ...
  public static void showFailedToLoadProjectDialog() { // {{{
    ...
    String content = locale.equals(Locale.JAPAN) ? "必要データの読み込みに失敗しました。" : "Failed to load datas.";
    alert.setContentText(content);
  ...
  public static void showResetProjectDirDialog() { // {{{
    ...
    String content = locale.equals(Locale.JAPAN) ? "お手数ですが、再設定してください。" : "Please reset one.";
    alert.setContentText(content);
  ...
  public static void showErrorDialog() { // {{{
    ...
    Locale locale = Locale.getDefault();
    String header =
        locale.equals(Locale.JAPAN) ? "フォルダはプロジェクトフォルダではありません。" : "Folder is not Project Folder.";
    alert.setHeaderText(header);
  ...
  public static void showFileNotFoundDialog() { // {{{
    ...
    Locale locale = Locale.getDefault();
    String header = locale.equals(Locale.JAPAN) ? "ファイルが見つかりませんでした。" : "File is not found.";
    alert.setHeaderText(header);
    if (locale.equals(Locale.JAPAN)) alert.setContentText("データを保存できませんでした。別名保存を実行してください。");
    else alert.setContentText("Please save as other file name.");
  ...
  public static void showSuccessDialog() { // {{{
    ...
    String header = locale.equals(Locale.JAPAN) ? "正常に出力できました。" : "Success Export MapXXX.json";
    alert.setHeaderText(header);

    if (locale.equals(Locale.JAPAN)) alert.setContentText("お疲れ様です。");
    alert.showAndWait();
  } // }}}
  ...
  public static void showFileEncodingDialog() { // {{{
    ...
    String header =
        locale.equals(Locale.JAPAN) ? "文字コードが対応していません。" : "UnsupportedEncodingException.";
    alert.setHeaderText(header);
  ...
  public static final void showParsingErrorDialog() { // {{{
    ...
    Locale locale = Locale.getDefault();
    String header =
        locale.equals(Locale.JAPAN) ? "一時データ保存時のXML変換に失敗しました。" : "Failed saving XML data.";
    alert.setHeaderText(header);
