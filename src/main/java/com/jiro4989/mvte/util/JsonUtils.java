...
public class JsonUtils {
  ...
  public static void writeValue(File outFile, Object data)
  ...
  public static void updateMapInfos(File file, String mapName, int id) throws IOException { // {{{
    ...
    if (id < list.size()) list.set(id, new MapInfos(id, mn, order, parentId));
    else list.add(new MapInfos(id, mn, order, parentId));
