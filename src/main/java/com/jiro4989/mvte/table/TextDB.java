...
public class TextDB {
  ...
  public TextDB( // {{{
      String icon, String actorName, String text, String background, String position) {
  ...
  public TextDB( // {{{
      String icon, List<String> textList, String background, String position) {
  ...
  public String toString() { // {{{
    return String.format(
        "TextDB: {icon: %s, actorName: %s, text: %s, background: %s, position: %s}",
